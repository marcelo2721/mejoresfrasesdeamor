          ...
          <article>
            ...
            <div className="prose max-w-none">
              ...
              <section className="mb-12">
                ...
                <div className="bg-white p-8 rounded-lg border-l-4 border-rose-500 shadow-md mb-6">
                  <h3 className="text-2xl font-serif font-bold text-rose-900 mb-4">
                ...
                <h4 className="text-xl font-semibold text-rose-900 mb-4">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <p key={i} className="text-lg italic text-rose-900 bg-rose-50 p-4 rounded">
                      {frase}
                    </p>
                  ))}
                </div>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <p key={i} className="text-lg text-rose-900 bg-rose-50 p-4 rounded">
                      "{frase}"
                    </p>
                  ))}
                </div>
